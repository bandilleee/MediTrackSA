...
export const ProfessionalConnect = () => {
  ...
  // Parallax effects matching your reference
  ...
  return (
    <section 
      ref={sectionRef}
      className="relative min-h-screen py-24 md:py-30 bg-gradient-to-b from-gray-900 to-black overflow-hidden"
    >
      ...
      <div className="container max-w-[1220px] w-full px-6 md:px-10 relative z-10 mx-auto">
        ...
        >
          ...
          <motion.div className="text-center mb-16" variants={itemVariants}>
            <div className="inline-block mb-4 px-4 py-1.5 bg-blue-500/10 rounded-full border border-blue-500/20">
            ...
            <p className="text-gray-300 text-sm md:text-[15px] leading-6 max-w-2xl mx-auto">
              Connect with our deployment team to discuss pilot programs, integration with 
              existing systems (CCMDD/RxSolution), and national scalability.
            </p>
          </motion.div>
          ...
          >
            {socialPlatforms.map((platform, index) => (
              ...
              >
                {/* Card Container */}
                <div className="relative bg-gray-800/30 backdrop-blur-sm border border-gray-700 rounded-2xl p-8 overflow-hidden transition-all duration-500 hover:border-gray-600/50">
                  ...
                  <div className="relative z-10">
                    ...
                    {/* Arrow Icon */}
                    <div className="mt-4 flex items-center text-gray-500 group-hover:text-white transition-all duration-300">
          ...
          <motion.div className="text-center" variants={itemVariants}>
            <button className="group relative inline-flex items-center gap-2 px-8 py-3 bg-gradient-to-r from-blue-600 to-purple-600 rounded-full text-white font-medium overflow-hidden transition-all duration-300 hover:scale-105">
